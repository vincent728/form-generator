...
--
-- Host: localhost
-- Generation Time: Apr 10, 2013 at 12:04 PM
...
(32, 'Boats', 8, 11),
(33, 'Cars & Trucks', 8, 11),
(34, 'Commercial Trucks', 8, 11),
(35, 'Motorcycle,Mopeds,ATVs  & VIbajaji', 8, 11),
(36, 'Books ,Movies & Music', 9, NULL),
(37, 'Clothing & Apparel', 9, NULL),
(38, 'Office space', 5, 12),
(39, 'Other commercial', 5, 12),
(40, 'Homes/Houses', 5, 6),
(41, 'Land /Property', 5, 6),
(42, 'Short Term Housing', 5, 5);
...
--
-- Table structure for table `forminputvalidationrules`
--

CREATE TABLE IF NOT EXISTS `forminputvalidationrules` (
  `validation_id` int(11) NOT NULL AUTO_INCREMENT,
  `input_rules` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`validation_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `forminputvalidationrules`
--

INSERT INTO `forminputvalidationrules` (`validation_id`, `input_rules`) VALUES
(1, 'required'),
(2, 'valid_email'),
(3, 'is_natural'),
(4, 'integer'),
...
(81, '*Make', 'select', 'make', '1', '*Make', 'make_id', 'make_type'),
...
(102, 'ApplicationDeadline', 'date', '', '1', 'ApplicationDeadline', '', ''),
(104, 'StartDate', 'date', '', '1', 'StartDate', '', ''),
...
(107, '*NGOType', 'multiselect', 'ngo_type', '1', '*NGOType', 'ngo_type_id', 'ngo_name'),
(108, 'PriceRanges', 'pricerange', '', '1', 'PriceRanges', '', ''),
(109, '*Trip Name', 'textinput', '', '1', '*TripName', '', ''),
(110, '*Minimum Price', 'price', '', '1', '*MinimumPrice', '', ''),
(111, 'ExpirationDate', 'date', '', '1', 'ExpirationDate', '', ''),
...
(114, 'EventStartDate', 'date', '', '1', 'EventStartDate', '', ''),
(115, 'EventEndDate', 'date', '', '1', 'EventEndDate', '', ''),
...
(123, 'EventEndTime', 'endtime', '', '1', 'EventEndTime', '', ''),
(124, 'Daterange', 'daterange', '', '1', 'Daterange', '', ''),
(125, 'View events by date', 'date', '', '1', 'Vieweventsbydate', '', ''),
(126, 'term search', 'select', 'term', '1', 'termsearch', 'term_id', 'term_description'),
(127, 'location search', 'select', 'area_tbl', '1', 'locationsearch', 'area_id', 'area_name'),
(128, 'amenities search', 'select', 'amenities', '1', 'amenitiessearch', 'amenity_id', 'amenity_name'),
(129, 'search for make', 'select', 'make', '1', 'searchformake', 'make_id', 'make_type'),
(130, 'search for transmission', 'select', 'transimission', '1', 'searchfortransmission', 'transimission_id', 'transimission_type'),
(131, 'search by kilometers', 'textinput', '', '1', 'searchbykilometers', '', ''),
(132, 'search by wheel drive', 'checkbox', '', '1', 'searchbywheeldrive', '', ''),
(133, 'search by date', 'date', '', '1', 'searchbydate', '', '');
...
INSERT INTO `search_forms` (`input_type_id`, `category_id`, `form_label`, `sections_without_subsections`, `displayOrder`, `no_input`, `input_tip`) VALUES
(108, 37, 'Price', '', 1, '1', NULL),
(108, 34, 'Price', '11', 1, '1', ''),
(124, 34, 'Date range', '11', 2, '1', ''),
(131, 34, 'Kilometers (Less than)', '11', 3, '1', ''),
(132, 34, 'Four Wheel drive', '11', 4, '1', ''),
(108, 35, 'Price', '11', 1, '1', ''),
(124, 35, 'Date range', '11', 2, '1', ''),
(131, 35, 'Kilometers (Less than)', '11', 3, '1', ''),
(108, 18, 'Rent', '5', 1, '1', ''),
(126, 18, 'Term', '5', 2, '1', ''),
(127, 18, 'Location', '5', 3, '1', ''),
(128, 18, 'Amenities', '5', 4, '1', ''),
(108, 40, 'Price', '6', 2, '1', ''),
(127, 40, 'Location', '6', 1, '1', ''),
(108, 41, 'Price', '6', 2, '1', ''),
(127, 41, 'Location', '6', 0, '1', ''),
(108, 38, 'Rent', '12', 0, '1', ''),
(126, 38, 'Term', '12', 2, '1', ''),
(127, 38, 'Location', '12', 3, '1', ''),
(108, 42, 'Rent', '5', 1, '1', ''),
(126, 42, 'Term', '5', 2, '1', ''),
(127, 42, 'Location', '5', 3, '1', ''),
(128, 42, 'Amenities', '5', 5, '1', ''),
(124, 27, 'Date range', '', 2, '1', ''),
(127, 27, 'Location', '', 3, '1', ''),
(133, 27, '', '', 1, '1', ''),
(108, 33, 'Price', '11', 1, '1', ''),
(124, 33, 'Date range', '11', 2, '1', ''),
(129, 33, 'Make', '11', 4, '1', ''),
(130, 33, 'Transmission', '11', 5, '1', ''),
(131, 33, 'Kilometers (Less than)', '11', 3, '1', ''),
(132, 33, '', '11', 6, '1', '');
...
(8, 'Used Cars,Trucks and boats'),
(9, 'Steal Deals & Classfields');

-- --------------------------------------------------------

--
-- Table structure for table `selectinputtypes`
--

CREATE TABLE IF NOT EXISTS `selectinputtypes` (
  `selectinputtypes_id` int(11) NOT NULL AUTO_INCREMENT,
  `selectinputtypes` varchar(45) NOT NULL,
  PRIMARY KEY (`selectinputtypes_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14 ;

--
-- Dumping data for table `selectinputtypes`
--

INSERT INTO `selectinputtypes` (`selectinputtypes_id`, `selectinputtypes`) VALUES
(1, 'textinput'),
(2, 'textarea'),
(3, 'checkbox'),
(4, 'file'),
...
(5, 'Tanzania housing  rentals', 5),
(6, 'Homes&property fo resale', 5),
(7, 'Travel & tourism Businesses', 3),
(8, 'Special Travel Offers', 3),
(9, 'Domestic staff', 7),
(10, 'Professional', 7),
(11, 'Car,Truck and Boat classfield', 8),
(12, 'Commercial rentals', 5);
