...
--
-- Host: localhost
-- Generation Time: Apr 08, 2013 at 02:03 PM
...
(104, 'StartDate', 'dateinput', '', '1', 'StartDate', '', ''),
...
(115, '*EventEndDate', 'dateinput', '', '1', '*EventEndDate', '', ''),
...
CREATE TABLE IF NOT EXISTS `search_forms` (
  ...
  `sectionwithsubsection_id` int(11) DEFAULT NULL,
...
INSERT INTO `search_forms` (`input_type`, `category_id`, `label`, `sectionwithsubsection_id`, `displayorder`, `no_input`) VALUES
(81, 33, '', 11, 3, '1'),
(83, 33, '', 11, 4, '1'),
(84, 33, '', 11, 5, '1'),
(108, 33, '', 11, 1, '1'),
