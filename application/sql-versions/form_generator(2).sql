...
--
-- Host: localhost
-- Generation Time: Mar 01, 2013 at 12:18 PM
...
--
-- Dumping data for table `forms_titles`
--

INSERT INTO `forms_titles` (`form_id`, `title`) VALUES
(5, 'Tanzania business directory'),
(6, 'Tanzania business directory'),
(7, 'Tanzania business directory'),
(8, 'Tanzania business directory'),
(9, 'Tanzania business directory'),
(10, 'Tanzania business directory'),
(11, 'Tanzania business directory'),
(12, 'Tanzania business directory'),
(13, 'Movies,dining,Arts &entertainement directory'),
(14, 'Movies,dining,Arts &entertainement directory'),
(15, 'Movies,dining,Arts &entertainement directory'),
(16, 'Tanzania business directory'),
(17, 'Movies,dining,Arts &entertainement directory'),
(18, 'Movies,dining,Arts &entertainement directory'),
(19, 'Movies,dining,Arts &entertainement directory'),
(20, 'Movies,dining,Arts &entertainement directory'),
(21, 'Movies,dining,Arts &entertainement directory'),
(22, 'Movies,dining,Arts &entertainement directory'),
(23, 'Movies,dining,Arts &entertainement directory'),
(24, 'Movies,dining,Arts &entertainement directory'),
(25, 'Tanzania business directory'),
(26, 'Movies,dining,Arts &entertainement directory');
...
CREATE TABLE IF NOT EXISTS `form_tbl` (
  ...
  PRIMARY KEY (`form_id`),
  KEY `fk_form_tbl_section_tbl1_idx` (`section_id`),
  KEY `fk_form_tbl_input_type_tbl1_idx` (`input_type_id`),
  KEY `fk_form_tbl_forms_titles1_idx` (`form_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `form_tbl`
  ...
  ADD CONSTRAINT `fk_form_tbl_forms_titles1` FOREIGN KEY (`form_id`) REFERENCES `forms_titles` (`form_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_form_tbl_section_tbl1` FOREIGN KEY (`section_id`) REFERENCES `section_tbl` (`section_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
