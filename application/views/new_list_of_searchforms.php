 ...
 if ($results->num_rows()>0) {
     ...
     <?php
            ...
            foreach ($results3->result_array() as $val) {
                ...
                $result_categories = $this->datafetcher->sectionCategory($val['section_id'], $table = "search_forms");
                ...
                foreach ($result_categories->result_array() as $forms) {
                    ...
                    if (!empty($forms['sections_without_subsections'])) {
                        ...
                        $results_subsections = $this->datafetcher->getSectionSubsections($val['section_id'], $forms['cat_id']);
